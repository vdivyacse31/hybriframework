...
public class TS_01_Registration extends CommonFuntions {
	...
	public void tc_04() throws Exception {
		...
		System.out.println("div"+timeStamp()+"@gamil.com");//div29Oct2025_191925@gamil.com
		driver.findElement(By.xpath("//*[@id=\"form\"]/div/div/div[3]/div/form/input[3]")).sendKeys("div"+timeStamp()+"@gamil.com");
	...
	public void tc_05() throws Exception {
		...
		//Validate Account Created! text has displayed after successfully registered
		verifyWebElement(By.xpath("//*[@id=\"form\"]/div/div/div/h2/b"));
		takeScreenshot("TS_01_Registration_tc_05_");
	}
